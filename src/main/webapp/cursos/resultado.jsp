      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12 text-center">
            ...
            <h3 class="text-center">Cdcurso:${cursos.cdcurso}</h3>
            <h3 class="text-center">Nome:${cursos.nome}</h3>
            <h3 class="text-center">Valor:${cursos.valor}</h3>
            <h3 class="text-center">Url:${cursos.url}</h3>
            </c:if>
          </div>
        </div>
      </div>
